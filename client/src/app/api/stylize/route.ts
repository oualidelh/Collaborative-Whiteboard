...
//     const { imageData, style, iterations = 1, strength = 0.7, seed } = body;
...
//     // Generate style prompt based on the selected style
//     const prompt = stylePrompts[style];

//     // Validate parameters
//     if (iterations < 1 || iterations > 5) {
//       return NextResponse.json(
//         { success: false, error: "Iterations must be between 1 and 5" },
//         { status: 400 }
//       );
//     }
...
//       return NextResponse.json(
//         { success: false, error: "Strength must be between 0.1 and 1.0" },
//         { status: 400 }
//       );
//     }
...
//       prompt,
//       iterations: parseInt(String(iterations)),
//       seed: parseInt(String(finalSeed)),
//       strength: parseFloat(String(strength)),
//     });
