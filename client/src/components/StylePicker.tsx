...
// import { stylizeImage } from "@/utils/stylize-client";
...
//         throw new Error(result.error || "Failed to stylize image");
//       }
...
//       toast.error(err instanceof Error ? err.message : "Failed to apply style");
...
//       {/* Style picker button */}
//       <Tooltip content="AI Style Options">
//         <Button
//           type="button"
//           onClick={toggleDropdown}
//           className="relative transition-transform hover-lift duration-300 w-9 h-9 flex items-center justify-center rounded-md border font-medium border-gray-200 shadow-sm
...
//       {/* Dropdown menu */}
//       {isOpen && (
//         <div className="style-picker absolute top-16 right-0 p-4 rounded-lg bg-gray-50 shadow-lg z-10 w-64">
//           <h3 className="text-lg font-semibold mb-3">Style Transfer</h3>
...
//                       : "bg-white border hover:bg-sage-600"
//                   }`}
//                   onClick={() => {
...
//                 : "bg-primary text-white hover:bg-sage-600"
//             }`}
//           >
...
//           variant="outline"
//           size="icon"
//           className={`h-9 w-9 ${isOpen ? "bg-accent" : ""}`}
//           onClick={toggleDropdown}
//           disabled={isProcessing}
//         >
//           {isProcessing ? (
...
//               </Button>
//             )}
//             <Button onClick={applyStyle} disabled={isProcessing} size="sm">
//               {isProcessing ? (
...
animate-moveGradient"
      ...
      {isOpen && (
        <div className="absolute md:right-0 sm:left-0 top-full z-50 mt-2 w-72 rounded-lg border bg-card p-4 shadow-lg">
          <div className="mb-4 flex items-center justify-between">
            <h3 className="text-sm font-semibold">Apply AI Style</h3>
            <Button
              variant="ghost"
